...
export const plantSpeciesSchema = z.object({
  ...
  flowering_season:     z.string().max(150).optional().or(z.literal('')),
  ...
  toxicity:             z.string().max(200).optional().or(z.literal('')),
  edible_parts:         z.string().max(200).optional().or(z.literal('')),
  native_region:        z.string().max(150).optional().or(z.literal('')),
  sunlight_needs:       z.string().max(100).optional().or(z.literal('')),
  watering_needs:       z.string().max(100).optional().or(z.literal('')),
