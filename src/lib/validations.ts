...
export const plantSpeciesSchema = z.object({
  ...
  flowering_season:     z.string().max(50,  'Max 50 characters').optional().or(z.literal('')),
  ...
  toxicity:             z.string().max(50,  'Max 50 characters').optional().or(z.literal('')),
  edible_parts:         z.string().max(200).optional().or(z.literal('')),
  native_region:        z.string().max(150).optional().or(z.literal('')),
  sunlight_needs:       z.string().max(30,  'Max 30 characters').optional().or(z.literal('')),
  watering_needs:       z.string().max(20,  'Max 20 characters').optional().or(z.literal('')),
  interesting_fact:     z.string().max(300, 'Max 300 characters').optional().or(z.literal('')),
